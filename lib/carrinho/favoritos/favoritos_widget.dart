              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Seus itens favoritos estão abaixo',
                        ...
                        itemBuilder: (context, favoritosIndex) {
                          ...
                          return Padding(
                            ...
                            child: StreamBuilder<ProdutosRecord>(
                              stream: ProdutosRecord.getDocument(favoritosItem),
                                                              ...
                                                              child: ToggleIcon(
                                                                onPressed:
                                                                  ...
                                                                  safeSetState(
                                                                    () => FFAppState()
                                                                            .favoritos
                                                                            .contains(containerProdutosRecord
                                                                                .reference)
                                                                        ? FFAppState().removeFromFavoritos(containerProdutosRecord
                                                                            .reference)
                                                                        : FFAppState()
                                                                            .addToFavoritos(containerProdutosRecord.reference),
                                                                  );
                                                                },
                                                                value: FFAppState()
                                                                    .favoritos

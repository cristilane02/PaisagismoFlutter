...
class _AdicionarProdutoWidgetState extends State<AdicionarProdutoWidget> {
  ...
  void initState() {
    ...
    _model.valorTextController1 ??= TextEditingController();
    _model.valorFocusNode1 ??= FocusNode();

    _model.valorTextController2 ??= TextEditingController();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 8.0),
                                  child: TextFormField(
                                    controller: _model.valorTextController1,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.valorTextController2,
                                          focusNode: _model.valorFocusNode2,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(

...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const LojaWidget() : const AutenticacaoWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'Loja',
              path: 'loja',
              builder: (context, params) => const LojaWidget(),
            ),
            FFRoute(
              name: 'Produto',
              path: 'produto',
            ...
            FFRoute(
              name: 'Editarpefil',
              path: 'editarpefil',
              builder: (context, params) => const EditarpefilWidget(),
            ),
            FFRoute(
              name: 'Favoritos',
              path: 'favoritos',
